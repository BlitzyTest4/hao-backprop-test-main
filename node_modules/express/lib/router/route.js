...
Route.prototype.dispatch = function dispatch(req, res, done) {
  ...
  function next(err) {
    ...
    // route handlers don't handle errors
    if (err) {
      return next(err);
    }
    ...
    if (method === 'options' && layer.method === undefined) {
      // don't call .handle() for options requests
      // if the layer has no method specified
      return next();
    }

    // this layer handles the method
