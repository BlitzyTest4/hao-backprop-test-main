...
SendStream.prototype.isPreconditionFailure = function isPreconditionFailure (stats) {
  ...
  if (match) {
    var etag = this._etag && this.res.getHeader('ETag')
  ...
  if (!isNaN(unmodifiedSince)) {
    var lastModified = parseHttpDate(this.res.getHeader('Last-Modified'))
...
/**
 * Class for sending files as a stream with a given path.
 *
 * @param {Request} req
 * @param {Response} res
 * @param {Function} next
...
function SendStream (req, path, opts) {
  Stream.call(this)
